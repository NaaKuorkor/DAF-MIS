...
@section('heading', 'Staff Portal')
@section('subheading', 'Enter your credentials to access your staff portal')
...
@section('content')
    ...
    <form action="{{ route('staff.login') }}" method="POST" class="space-y-6">
        ...
        {{-- Back to Home/Student Login Link (Optional but good UX) --}}
        <div class="mt-6 text-center text-sm text-gray-500">
             Not a staff member?
            <a href="{{ route('login') }}" class="font-semibold text-purple-600 hover:text-purple-500 hover:underline">
                Student Login
            </a>
        </div>
    </form>
