        ...
        <aside id="sidebar" class="bg-purple-800 border-r border-purple-900 h-full w-64 flex flex-col justify-between sidebar-transition z-20 relative flex-shrink-0">
            <div>
                ...
                <div class="h-16 flex items-center px-6 border-b border-purple-900">
                    ...
                    <span class="ml-3 font-semibold text-white tracking-tight logo-text">Staff Portal</span>
                </div>
        ...
        <div class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <header class="h-16 bg-white/80 backdrop-blur-md border-b border-purple-200 flex items-center justify-end px-6 sticky top-0 z-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        <button id="announcementBellIcon" class="p-2 text-gray-500 hover:bg-purple-50 rounded-full transition-colors relative">
                        ...
                        <div id="announcementDropdown" class="hidden absolute right-0 mt-2 w-96 bg-white rounded-xl shadow-2xl border border-gray-200 z-50 max-h-[600px] overflow-hidden">
                            <div class="p-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-purple-50 to-purple-100">
                                ...
                                <button id="viewAllAnnouncementsLink" class="text-xs font-medium text-purple-600 hover:text-purple-700 transition-colors">
                                    View All →
                                </button>
                            </div>
                            <div id="announcementDropdownContent" class="max-h-[400px] overflow-y-auto">
