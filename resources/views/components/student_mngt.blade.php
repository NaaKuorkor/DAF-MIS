{{-- resources/views/components/dashboard/student-management.blade.php --}}
<div class="content-fade">
    <!-- Page Header + Toolbar -->
    <div class="flex flex-col gap-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 tracking-tight">Student Management</h1>
                <p class="text-sm text-gray-500 mt-1">Manage enrollments, student profiles, and academic records.</p>
            </div>
            <div class="flex gap-3">
                <x-import-students-modal />
                <a href="{{ route('exportStudents') }}" class="px-3 py-2 bg-white border border-purple-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 hover:border-purple-300 transition-all shadow-sm flex items-center gap-2 group">
        ...
        <div class="flex flex-col md:flex-row gap-4 md:items-center justify-between p-1">
            <div class="relative w-full md:w-80">
                ...
                <input type="text" id="searchStudent" placeholder="Search by name, course or id..." class="w-full pl-10 pr-4 py-2 bg-white border border-purple-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all placeholder:text-gray-400 shadow-sm">
            </div>
    ...
    <div class="bg-white border border-purple-200 rounded-xl shadow-sm overflow-hidden">
        <div class="overflow-x-auto no-scrollbar">
            <table class="w-full text-left border-collapse whitespace-nowrap">
                ...
                <tbody class="divide-y divide-purple-100" id="tableRows">
        ...
        <div class="flex items-center justify-between p-4 border-t border-purple-100 bg-white">
            <p class="text-xs text-gray-500">Showing <span class="font-medium text-gray-900" id="showing-count">0</span> students</p>
