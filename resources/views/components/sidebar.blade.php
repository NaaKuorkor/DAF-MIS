        ...
        <div
            ...
            <div class="overflow-hidden fixed inset-0">
                <div class="overflow-hidden absolute inset-0">
                    ...
                    <div class="flex fixed inset-y-0 left-0 pt-11 pl-10 max-w-full">
                        <div
                            x-show="slideOverOpen"
                                ...
                                <div class="px-4 sm:px-5">
                                    <div class="flex justify-between items-start pb-1">
                                        ...
                                        <div class="flex items-center ml-3 h-auto">
                                            <button @click="slideOverOpen=false" class="flex absolute left-0 z-30 justify-center items-center px-3 py-2 mt-6 mr-5 space-x-1 text-xs font-medium uppercase rounded-md border border-neutral-200 text-neutral-600 hover:bg-neutral-100">
