...
<section class="px-6 pb-12 w-full antialiased bg-white">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="container py-32 mx-auto mt-px max-w-sm text-left sm:max-w-md md:max-w-lg sm:px-4 md:max-w-none md:text-center">
                <h1 class="text-3xl font-bold tracking-tight leading-10 text-left text-gray-900 md:text-center sm:text-4xl md:text-7xl lg:text-8xl"><br class="hidden sm:block">
            ...
            <div class="flex flex-col justify-center items-center mt-8 space-y-4 text-center sm:flex-row sm:space-y-0 sm:space-x-4">
                ...
                <span class="inline-flex relative w-full md:w-auto">
                    <a href="#_" class="inline-flex justify-center items-center px-8 py-4 w-full text-base font-medium leading-6 text-gray-900 bg-gray-100 rounded-full border border-transparent xl:px-10 md:w-auto hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200">Learn More</a>
                </span>
            </div>
        </div>
