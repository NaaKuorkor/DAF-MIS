        ...
        <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
            ...
            <div x-show="modalOpen"
                ...
                <div class="relative w-auto">
                    ...
                    <form method="POST" action="{{ route('register')}}" id="registerStudent">
                        @csrf
                        <div class="flex mb-4 space-x-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="mname" name="mname" placeholder="Optional" class="focus:outline-none focus:ring-2 focus:ring-purple-300  border border-gray-400 h-8 p-2 w-full rounded-md">
                            </div>
                            <div>
                        ...
                        <div class="flex mb-4 space-x-4">
                            ...
                            <div>
                                <label for="confirm" class="block text-gray-600">Confirm</label>
                                <input type="password" id="confirm" name="password_confirmation" minlength=8 autocomplete="new-password" class="focus:outline-none focus:ring-2 focus:ring-purple-300 border border-gray-400 h-8 p-2 w-full rounded-md">
                            </div>
                            <div>
                        ...
                        <div class="flex justify-center">
                            <button @click="modalOpen=false" type="submit" class="mb-4 bg-purple-600 hover:bg-purple-700 rounded-lg text-white font-bold w-50 text-center h-10 shadow">Register</button>
                        </div>
